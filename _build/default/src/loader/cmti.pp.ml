...
# 61 "src/loader/cmti.ml"
        let arg = read_core_type env container arg
        
# 63 "src/loader/cmti.ml"
        in
...
# 155 "src/loader/cmti.ml"
    | Ttyp_open (_p,_l,t) ->
      (* TODO: adjust model *)
      read_core_type env container t

# 160 "src/loader/cmti.ml"
...
# 315 "src/loader/cmti.ml"
  | Text_decl(_, args, res) ->
    
# 319 "src/loader/cmti.ml"
    let args =
      read_constructor_declaration_arguments
...
# 348 "src/loader/cmti.ml"
  | Text_decl(_, args, res) ->
    
# 352 "src/loader/cmti.ml"
    let args =
      read_constructor_declaration_arguments
        env container label_container args
    in
...
# 783 "src/loader/cmti.ml"
  let signature = o.open_bound_items in
  
# 787 "src/loader/cmti.ml"
