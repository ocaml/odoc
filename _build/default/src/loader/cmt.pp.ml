...
# 45 "src/loader/cmt.ml"
    | Tpat_var(id,_,_uid) ->
        
# 47 "src/loader/cmt.ml"
        let open Value in
...
# 56 "src/loader/cmt.ml"
    | Tpat_alias(pat, id, _,_) ->
        
# 58 "src/loader/cmt.ml"
        let open Value in
        let id = Env.find_value_identifier env.ident_env id in
          Cmi.mark_type_expr pat.pat_type;
          let type_ = Cmi.read_type_expr env pat.pat_type in
...
# 70 "src/loader/cmt.ml"
    | Tpat_construct(_,_,pats,_) ->
        
# 72 "src/loader/cmt.ml"
        List.concat (List.map (read_pattern env parent doc) pats)
...
# 209 "src/loader/cmt.ml"
    | Tcty_open _ -> assert false

# 212 "src/loader/cmt.ml"
...
# 411 "src/loader/cmt.ml"
    | Tmod_apply _ ->
        Cmi.read_module_type env parent (Odoc_model.Compat.module_type mexpr.mod_type)
    
# 414 "src/loader/cmt.ml"
    | Tmod_apply_unit _ ->
        Cmi.read_module_type env parent (Odoc_model.Compat.module_type mexpr.mod_type)
    
# 417 "src/loader/cmt.ml"
...
# 544 "src/loader/cmt.ml"
          (fun (cl, _) -> cl)
          
# 546 "src/loader/cmt.ml"
          cls in
...
# 584 "src/loader/cmt.ml"
  let signature = o.open_bound_items in
  
# 588 "src/loader/cmt.ml"
