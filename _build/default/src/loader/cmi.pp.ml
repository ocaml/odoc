...
# 219 "src/loader/cmi.ml"
       | Reither(c, l, _) ->
           
# 223 "src/loader/cmi.ml"
...
# 276 "src/loader/cmi.ml"
      | Tpackage(_,tyl) ->
          List.iter (fun (_,x) -> loop visited x) tyl
      
# 285 "src/loader/cmi.ml"
      | Tsubst (ty,_) -> loop visited ty
      
# 287 "src/loader/cmi.ml"
...
# 488 "src/loader/cmi.ml"
      | Tpackage(p,eqs) ->
          
# 493 "src/loader/cmi.ml"
...
# 508 "src/loader/cmi.ml"
      | Tsubst (typ,_) -> read_type_expr env typ
      
# 510 "src/loader/cmi.ml"
      | Tlink _ -> assert false
    in
      match alias with
      | None -> typ
...
# 562 "src/loader/cmi.ml"
              | Reither(constant, typs, _) ->
                
# 566 "src/loader/cmi.ml"
                let arguments =
...
# 687 "src/loader/cmi.ml"
  | Type_abstract _ ->
    
# 691 "src/loader/cmi.ml"
    None
  
# 693 "src/loader/cmi.ml"
  | Type_variant (cstrs,_) ->
        
# 697 "src/loader/cmi.ml"
        let cstrs =
...
# 714 "src/loader/cmi.ml"
  let _, _, inj = Variance.get_lower var in
  
# 716 "src/loader/cmi.ml"
  inj
...
# 769 "src/loader/cmi.ml"
    | Type_abstract _ ->
        
# 773 "src/loader/cmi.ml"
        decl.type_manifest = None || decl.type_private = Private
    | Type_record _ ->
        decl.type_private = Private
  
# 777 "src/loader/cmi.ml"
  | Type_variant (tll,_) ->
        
# 781 "src/loader/cmi.ml"
        decl.type_private = Private ||
