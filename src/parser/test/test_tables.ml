               ...
               ((row
                ...
                (row
                 ((data
                   (((f.ml (8 16) (8 36))
                     (paragraph
                      (((f.ml (8 16) (8 20)) (word aaaa))
                       ((f.ml (8 20) (8 21)) space) ((f.ml (8 21) (8 24)) (word bbb))
                       ((f.ml (8 24) (8 25)) space) ((f.ml (8 25) (8 28)) (word ccc))
                       ((f.ml (8 28) (8 29)) space)
                       ((f.ml (8 29) (8 36))
             ...
             (table (syntax light)
              (grid
               ((row
                 ((data
                   (((f.ml (4 9) (4 10))
                     (paragraph (((f.ml (4 9) (4 10)) (word x)))))))
                  (data
                   (((f.ml (4 13) (4 14))
               ...
               (table (syntax light)
                (grid
                 ((row
                   ((data
                     (((f.ml (3 9) (3 10))
                       (paragraph (((f.ml (3 9) (3 10)) (word x)))))))
                    (data
                     (((f.ml (3 13) (3 14))
             ...
             (table (syntax light)
              (grid
               ((row
                 ((header
                   (((f.ml (3 9) (3 10))
                     (paragraph (((f.ml (3 9) (3 10)) (word a)))))))
                  (header
                   (((f.ml (3 13) (3 14))
               ...
               (table (syntax light)
                (grid
                 ((row
                   ((header
                     (((f.ml (4 9) (4 10))
                       (paragraph (((f.ml (4 9) (4 10)) (word a)))))))
                    (header
                     (((f.ml (4 13) (4 14))
                  ...
                  (row
                   ((data
                     (((f.ml (8 9) (8 10))
                       (paragraph (((f.ml (8 9) (8 10)) (word a)))))))
                    (data
                     (((f.ml (8 13) (8 14))
              ...
              (grid
               ((row
                ...
                (row
                 ((data
                   (((f.ml (5 9) (5 10))
                     (paragraph (((f.ml (5 9) (5 10)) (word x)))))))
                  (data
                   (((f.ml (5 13) (5 14))
