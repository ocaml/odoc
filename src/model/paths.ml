...
module Reference = struct
  module Resolved = struct
    ...
    and unboxed_field_parent_identifier : unboxed_field_parent -> Identifier.UnboxedFieldParent.t =
      function
      | `Identifier id -> id
      | `Type _ as t -> (parent_type_identifier t :> Identifier.UnboxedFieldParent.t)
    ...
    and identifier : t -> Identifier.t = function
      ...
      | `UnboxedField (p, n) ->
        Identifier.Mk.unboxed_field (unboxed_field_parent_identifier p, n)
      | `PolyConstructor (s, n) ->
