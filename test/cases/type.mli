...
type long = labeled_higher_order -> [ `Bar | `Baz of triple] -> pair -> labeled -> higher_order -> (string -> int) -> (int,float,string,Int64.t,char,unit) CamlinternalFormatBasics.fmtty -> nested_pair -> arrow -> String.t -> nested_pair array
