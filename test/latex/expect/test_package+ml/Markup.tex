\section{Module \ocamlinlinecode{Markup}}\label{cpage-test+u+package+++ml-module-Markup}%
...
Sections can have attached \hyperref[cpage-test+u+package+++ml-module-Markup-anchors]{\ocamlinlinecode{Anchors}[p\pageref*{cpage-test+u+package+++ml-module-Markup-anchors}]}, and it is possible to \hyperref[cpage-test+u+package+++ml-module-Markup-anchors]{\ocamlinlinecode{link}[p\pageref*{cpage-test+u+package+++ml-module-Markup-anchors}]} to them. Links to section headers should not be set in source code style.
...
This is a reference to \hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{\ocamlinlinecode{foo}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}. References can have replacement text: \hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{the value foo}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}. Except for the special lookup support, references are pretty much just like links. The replacement text can have nested styles: \hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{\bold{bold}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}, \hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{\emph{italic}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}, \hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{\emph{emphasis}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}, \hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{super\textsuperscript{script}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}, \hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{sub\textsubscript{script}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}, and \hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{\ocamlinlinecode{code}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}. It's also possible to surround a reference in a style: \bold{\hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{\ocamlinlinecode{foo}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}}. References can't be nested inside references, and links and references can't be nested inside each other.
...
\item{\hyperref[cpage-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{\ocamlinlinecode{foo}}[p\pageref*{cpage-test+u+package+++ml-module-Markup-val-foo}]}}\end{itemize}%
}\end{itemize}%
...
\label{cpage-test+u+package+++ml-module-Markup-val-foo}\ocamlcodefragment{\ocamltag{keyword}{val} foo : unit}\begin{ocamlindent}Comments in structure items \bold{support} \emph{markup}, t\textsuperscript{o}\textsubscript{o}.\end{ocamlindent}%
\medbreak
