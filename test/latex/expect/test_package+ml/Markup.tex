\section{Module \ocamlinlinecode{Markup}}\label{page-test+u+package+++ml-module-Markup}%
...
\item{\hyperref[page-test+u+package+++ml-module-Markup-val-foo]{\ocamlinlinecode{\ocamlinlinecode{foo}}[p\pageref*{page-test+u+package+++ml-module-Markup-val-foo}]}}\end{itemize}%
}\end{itemize}%
...
\label{page-test+u+package+++ml-module-Markup-val-foo}\ocamlcodefragment{\ocamltag{keyword}{val} foo : unit}\begin{ocamlindent}Comments in structure items \bold{support} \emph{markup}, t\textsuperscript{o}\textsubscript{o}.\end{ocamlindent}%
\medbreak
