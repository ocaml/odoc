\section{Module \ocamlinlinecode{Section}}\label{page-test+u+package+++ml-module-Section}%
...
\label{page-test+u+package+++ml-module-Section-val-foo}\ocamlcodefragment{\ocamltag{keyword}{val} foo : unit}\\
\subsection{Empty section\label{empty-section}}%
